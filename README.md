About lyricsmaster-feedstock
============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/lyricsmaster-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/SekouD/lyricsmaster

Documentation: https://lyricsmaster.readthedocs.io/en/latest/
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5933&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/lyricsmaster-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `lyricsmaster` can be installed with `conda`:
...
```
mamba install lyricsmaster
```

It is possible to list all of the versions of `lyricsmaster` available on your platform with `conda`:
...
```
mamba search lyricsmaster --channel conda-forge
```
...
mamba repoquery search lyricsmaster --channel conda-forge

# List packages depending on `lyricsmaster`:
mamba repoquery whoneeds lyricsmaster --channel conda-forge

# List dependencies of `lyricsmaster`:
mamba repoquery depends lyricsmaster --channel conda-forge
```
